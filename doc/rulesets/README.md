...
Each map line consists of three fields, separated by double colons, with an optional comment after the hash sign. The three fields are mandatory (the third one can be empty, have the value "stop," or any other value):
